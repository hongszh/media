/* 
** https://memorytoco.gitbook.io/wayland-gui/first-blackbox
 */
...
int main(void)
{
    ...
    // int fd = syscall(SYS_memfd_create, "buffer", 128);
    // error: error marshalling arguments for create_pool: dup failed: 
    // Bad file descriptor, 报这个错误的时候直接用memfd_create
    ftruncate(fd, size);
